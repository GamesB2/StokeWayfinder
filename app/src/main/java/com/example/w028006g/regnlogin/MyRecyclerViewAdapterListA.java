...
public class MyRecyclerViewAdapterListA extends RecyclerView.Adapter<MyRecyclerViewAdapterListA.CustomViewHolder> {
    private ArrayList<POI> feedItemList;
    private Context mContext;
    private OnItemClickListener onItemClickListener;

    public MyRecyclerViewAdapterListA(Context context, ArrayList<POI> feedItemList) {
    ...
    public CustomViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.a_row, null);
