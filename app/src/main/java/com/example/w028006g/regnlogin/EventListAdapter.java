...
public class EventListAdapter extends ArrayAdapter<Event> {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		case "dwell":
			typeImageIv.setImageResource(R.drawable.background);
			break;
		case "enter":
			typeImageIv.setImageResource(R.drawable.background);
			break;
		...
		//TextView typeTv = (TextView) rowView.findViewById(R.id.button);
		//typeTv.setText(e.getType());

		//TextView placenameTv = (TextView) rowView.findViewById(R.id.profile);
