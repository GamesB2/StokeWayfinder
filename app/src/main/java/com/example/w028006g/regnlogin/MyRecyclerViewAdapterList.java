...
public class MyRecyclerViewAdapterList extends RecyclerView.Adapter<MyRecyclerViewAdapterList.CustomViewHolder> {
    private ArrayList<POI> feedItemList;
    private Context mContext;
    private OnItemClickListener onItemClickListener;

    public MyRecyclerViewAdapterList(Context context, ArrayList<POI> feedItemList) {
    ...
    public CustomViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.e_row, null);
